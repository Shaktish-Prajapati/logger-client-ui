                      ...
                      props => (
                        <div className='logtableStyle' className='mt-5'>
                          ...
                          <div className="row">
                            <Col>
                              <Row>
                                <Col xl={12}>  <label style={{ color: '#3E8BE2', fontWeight: 'bold', float: 'left' }} >Start date </label>
                                  <input type="date" ref={startDateRef} value={date.start} onChange={e => setDate({ ...date, start: e.target.value })} className={emptyDate ? "dateempty form-control" : "form-control"} style={{ color: '#3E8BE2', fontWeight: 'bold', float: 'left' }} /></Col>
                                <Col xl={12}>   <label style={{ color: '#3E8BE2', fontWeight: 'bold', float: 'left' }} >End date </label>
                                  <input type="date" ref={endDatRef} max={Date.now()} value={date.end} onChange={e => setDate({ ...date, end: e.target.value })} className={emptyDate ? "dateempty form-control" : "form-control"} style={{ color: '#3E8BE2', fontWeight: 'bold', float: 'left' }} /></Col>
                                <Col xl={12}>   <button type="button" onClick={filterOnDate} style={{ background: '#3E8BE2', fontWeight: 'bold', float: 'left', verticalAlign: 'center', marginTop: '8%' }} className="btn btn-primary">Apply date</button></Col>
                              </Row>
                            </Col>
                              ...
                              <Row>
                                <Col lg={12}>
                                  <div className="pagesOption" style={{ marginTop: '33px' }}>
                                    <div className="selectBox pagesOption" /* style={{borderColor:'#3E8BE2', justifyContent:'center', alignItems:'center', display:'flex'}} */ onClick={showCheckboxes}>
                                      <select style={{ borderColor: '#3E8BE2', background: 'none', color: '#3E8BE2', /* marginTop:'12%', */ borderRadius: '5px', height: '35px', justifyContent: 'center', alignItems: 'center' }}  >
                                ...
                                <Col lg={12}><button type="button" onClick={resetFilter} style={{ background: '#3E8BE2', fontWeight: 'bold', float: 'left', verticalAlign: 'center', marginTop: '8%' }} className="btn btn-primary">Reset Filter</button></Col>
                              </Row>
                            </div>
