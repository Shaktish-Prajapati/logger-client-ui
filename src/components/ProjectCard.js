    ...
    return (<>
                ...
                <Col sm={4} >
                    ...
                    <Card.Title style={{textAlign:'left', color:'#212529'}}>{props.data.name}</Card.Title>
                        ...
                        <Link to={`/logTables?code=${props.data.code}&name=${props.data.name} `} className="rightLinkButton"> <FontAwesomeIcon style={{fontSize:'200%'}}  className='fontAwesomeIconRight' icon={faArrowCircleRight} /> </Link>
                    </Card.Body>
                    </Card>
                </Col>
